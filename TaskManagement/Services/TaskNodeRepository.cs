...
namespace TaskManagement.Services
{
    public class TaskNodeRepository : ITaskNodeRepository
    {
        ...
        //если мерить просто через DateTime.Subtract(), то тогда будет считаться и время, когда задачи были Suspend
        //такой подход считает только когда задачи Executing
        /// <summary>
